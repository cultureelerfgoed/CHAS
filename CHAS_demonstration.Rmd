...
If you want to try out the scripts on your own collection data, read through the README of the [CHAS repo](https://github.com/cultureelerfgoed/CHAS) and use the [CHAS_report file](https://github.com/cultureelerfgoed/CHAS/blob/main/CHAS_report.Rmd) on your own dataset. Note that some experience with programming, SPARQL and/or data science may be required.
